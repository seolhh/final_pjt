...
export default {
  ...
  created() {
    ...
    axios({
      method: "get",
      url: `https://api.themoviedb.org/3/movie/${movieID}?api_key=7bb67a4aaf34874058920f02257aada7&language=ko-KR`,
    }).then((res) => {
    ...
    axios({
      method: "get",
      url: `https://api.themoviedb.org/3/movie/${movieID}/credits?api_key=7bb67a4aaf34874058920f02257aada7&language=en-US`,
    })
      .then((res) => {
